...
class SaveBestModel:
    ...
    """
    def __init__(
        self, best_val_map=float(0)
    ):
        self.best_val_map = best_val_map
    ...
    def __call__(
        ...
        if current_val_map > self.best_val_map:
            self.best_val_map = current_val_map
            print(f"\nBEST VALIDATION mAP: {self.best_val_map}")
